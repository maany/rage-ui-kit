"use client";
import { CardContent, CardDescription, CardHeader, CardTitle, Card as ShadcnCard } from "@/ui/card";
...
export const LoginCard = ({
  ...
  return (
<ShadcnCard className={`sm:max-w-md ${isDarkMode ? "bg-neutral-800 text-white" : "bg-neutral-100 text-black"}`}
>
              ...
              <button
                ...
                >
                  {showPassword ? (
                    ...
                    viewBox="0 0 16 16"
                  >
                    <path fill-rule="evenodd" d="M0 8s3-5.5 8-5.5S16 8 16 8s-3 5.5-8 5.5S0 8 0 8zM8 4.5a3.5 3.5 0 1 0 0 7 3.5 3.5 0 0 0 0-7z"/>
                    <path fill-rule="evenodd" d="M11.354 12.354a2 2 0 0 1-2.708-2.707L9.414 8 8 9.414l-1.354-1.353a2 2 0 0 1-2.708 2.708l-.707-.707a3 3 0 0 0 4.242-4.242l-.707-.707a4 4 0 0 1 5.656 5.656l-.707.707z"/>
                  </svg>
                  ) : (
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
