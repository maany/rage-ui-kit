...
export const CreateConversationDialog = ({
  ...
  const [inputValues, setInputValues] = useState<{ conversationTitle: string }>(
    { conversationTitle: "" },
  );
  ...
  const [validation, setValidation] = useState<{ conversationTitle: boolean }>({
      ...
      >
        ...
        <label>
          ...
          <ShadcnInput
            ...
            onChange={(e) =>
              handleInputChange("conversationTitle", e.target.value)
            }
